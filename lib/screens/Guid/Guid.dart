...
class Guid extends StatelessWidget {
  final List<Map<String, dynamic>> categories = [
    ...
    },
    {
      ...
      'icon': Icons.restaurant,  // Changed from non-existent nutrition to restaurant
      'page': const NutritionTipsPage(),
      'color': Colors.purple
    },
    {
      'title': 'مراقبة السكر',
      'icon': Icons.monitor_heart_outlined,  // Changed to outlined version which exists
      'page': const SugarMonitoringPage(),
      'color': Colors.red
    },
    {
      'title': 'مضاعفات إهمال السكري',
      'icon': Icons.sick,
      'page': const ComplicationsPage(),
  ...
  Widget build(BuildContext context) {
    return AnnotatedRegion<SystemUiOverlayStyle>(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          title: const Text('الدليل التوعوي لمرض السكري'),
          centerTitle: true,
